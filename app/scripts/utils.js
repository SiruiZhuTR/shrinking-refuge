...
Reuters.autoCropMedia = function($container, $offsetElement, additionalOffset, autoResize = true){
...
Reuters.centerFullSizeMedia = function($container, $media, mediaType, autoResize = true){
...
Reuters.initStatTracking = function(){
    ...
    let scrollDepthOpts = {elements: elements};
    let rivetedOpts = {reportInterval: 20, idleTimeout: 60, nonInteraction: false};
    try{
